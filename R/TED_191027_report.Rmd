...
pander(table(ted1027$group, ted1027$submit))
pander(chisq.test(table(ted1027$group, ted1027$submit)))
```
...
pander(table(cut(ted1027$days, breaks = c(0:14), include.lowest = TRUE)), caption = "일 단위")
...
pander(table(cut(ted1027$hours, breaks = breaks3, include.lowest = TRUE)), caption = "시간 단위")
```
...
```{r, echo = FALSE}
pander(table(ted1027$group, ted1027$bird))
...
```{r, echo = FALSE}
pander(t.test(n_chars ~ group, data = ted1027))
```
...
```{r, echo = FALSE}
pander(t.test(n_chars ~ bird, data = ted1027))
```
