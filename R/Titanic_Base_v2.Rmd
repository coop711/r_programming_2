...
library(showtext)
## fonts.google.com에서 폰트 다운로드 받아 추가 
## Nanum Gothic Regular 를 사용하고, Noto Sans KR 을 그림의 타이틀 폰트로 
...
par(mfrow = c(1, 2), family = "Nanum Gothic")
#> Titanic %>% 
#>   apply(MARGIN = c(4, 1), FUN = sum)
pos <- function(x){
  cumsum(x) - x / 2
...
par(mfrow = c(1, 1), family = "Nanum Gothic")
