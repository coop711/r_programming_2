...
## Comments
안핀사람,금연한사람,흡연하는 사람 순으로 몸의 건강이 안좋다는 결과를 볼 수 있으며 폐암의 걸리는 확률 또한 저 순서대로 이다. 또한 흡연여부의 따라 수명도 결정된다고 한다. 하지만 암이나 질병같은 것들은 유전적 요인도 있는데 그렇다면 쌍둥이들은 어떠한지 결과를 막대그래프, Mosaic Plot, ggplot으로 추출하여 살펴볼 수 있었다.