...
text(x = rep(b1, each = 3), y = y_text, labels = c(Nature1))
#> 범례 표시
legend("topleft", inset = 0.01, fill = cols[3:1], legend = rev(colnames(Nature1)), bty = "n")
#> 메인 타이틀 
...
text(rep(b2, each = 2), y_text2, labels = c(Nature2))
legend("topleft", inset = 0.01, fill = cols[2:1], legend = rev(colnames(Nature2)))
...
text(rep(b3, each = 2), y_text3, labels = c(Nature3))
legend("topleft", inset = 0.01, fill = cols[2:1], legend = rev(colnames(Nature2)))
