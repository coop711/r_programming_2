...
##> "01월01일" 등의 포맷으로 합치기. str_c 용법 알아볼 것.
...
include_graphics("../pics/birthday_Qs.png", dpi = NA)
```
...
birthday$month %<>%
  factor(levels = unique(birthday$month), 
